...
const bot = new Telegraf('1817748802:AAFZVzD3PZzBj4TsgOsK-Ndk3OAiURTj-pc');
let channel1 = "@demobotnode";
let channel2 = "@demonodechanel";
var admin = '1676897369'
let db
...
mongo.connect('mongodb+srv://refer:scD9rT2AEMzKoZsW@cluster0.bqqkj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', { useUnifiedTopology: true }, (err, client) => {
  if (err) {
    console.log(err)
  }
